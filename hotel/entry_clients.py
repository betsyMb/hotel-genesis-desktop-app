...
class EntryClient:
    ...
    def __init__(self, window):
      ...
      frame = LabelFrame(self.wind, text='Nueva entrada')
      ...
      # Habitacion
      Label(frame, text='Nro de habitacion: ').grid(row=5, column=0)
      self.birth_date = Entry(frame)
      self.birth_date.grid(row=5, column=1)
            
      
      # Button Add Product
      ttk.Button(frame, text="Guardar entrada").grid(row=6, columnspan=2, sticky=W + E)
